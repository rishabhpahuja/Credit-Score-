...
orig_data.to_csv('orign.csv')
y_label=orig_data.loc[:,len(orig_data.columns)-1]

# print("monthly",orig_data.loc[17,:]==50000)
# print("monthly",orig_data.loc[:,31])
...
# print(orig_data)
orig_data.to_csv('Cleaned_Data.csv',index=False,header=False)
y_label.to_csv('Data_labels.csv',index=False,header=False)
